...
<body>
	...
	<div class="row">
		<div class="col-lg-4 text-center">
			<img src="images/glasses/sunglasses.png"/>

		</div>
		<div class="col-lg-4 text-center">
			<img src="images/glasses/sunglasses1.png"/>
        ...
        <div class="product-price row">
          ...
          <br/>
          <form method="post">
          <input type="submit"name="next_glasses_product" class="btn btn-success col-lg-2" value="Next" style="margin-left:-20px; float:left;"/> 
